...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "add":
        ...
        await query.edit_message_text("Напиши название:")

    elif data == "enter_desc":
        user_state[chat_id]["step"] = "desc"
        await query.edit_message_text("Напиши описание:")

    elif data == "enter_price":
        user_state[chat_id]["step"] = "price"
        await query.edit_message_text("Напиши сумму:")
        ...
        await query.edit_message_text("Добавление через кнопки.", reply_markup=main_keyboard())
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if step == "title":
        ...
        await update.message.reply_text(
            "Ок",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Ввести описание", callback_data="enter_desc")]])
        )
        ...
        await update.message.reply_text(
            "Ок",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Ввести сумму", callback_data="enter_price")]])
        )
